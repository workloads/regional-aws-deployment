locals {
  ...
  server_config_nomad = templatefile("${path.module}/templates/nomad-server-config.tftpl.hcl", {
    ...
    join_tags = [
      ...
      "provider=aws region=af-south-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-east-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-northeast-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-northeast-2 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-northeast-3 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-south-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-southeast-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-southeast-2 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ap-southeast-3 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=ca-central-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-central-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-north-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-south-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-west-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-west-2 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=eu-west-3 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=me-south-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=sa-east-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=us-east-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=us-east-2 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=us-west-1 tag_key=nomad:role tag_value=server addr_type=public_v4",
      "provider=aws region=us-west-2 tag_key=nomad:role tag_value=server addr_type=public_v4",
    ]
